...
--------------------------
The simplest possible AgentKthx agent — no tools, just conversation.
...
def parse_args():
    parser = argparse.ArgumentParser(description="AgentKthx Basic Agent")
