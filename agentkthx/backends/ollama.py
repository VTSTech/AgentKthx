...
class OllamaBackend(BaseBackend):
    ...
    def generate_decision(
        ...
        **kwargs,
        ...
        # R05.8: Surface reasoning_content if the underlying thinking model
        # emitted one. Useful when --think is set and the user wants to see
        # what the model was reasoning about before its decision.
    ...
    def _maybe_jev_dispatch(
        ...
        **kwargs,
        ...
        return {
            ...
            "reasoning_content": decision.get("reasoning_content", ""),  # R05.8
            "raw": decision,
            "_jev": True,
        }
